...
function createForClass(typeId){
  var clazz, clazz_0;
  clazz = (clazz_0 = new Class , clazz_0.typeName = 'Class$' + (typeId?'S' + typeId:'' + clazz_0.sequentialId) , clazz_0.canonicalName = clazz_0.typeName , clazz_0.simpleName = clazz_0.typeName , clazz_0);
